...
const Home = () => {
  ...
  return (
    <div className="flex flex-col gap-16 pb-20 bg-gradient-to-b from-purple-50 to-pink-50">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-purple-600 via-pink-400 to-indigo-600 text-white py-24 text-center overflow-hidden">
      ...
      <section className="container mx-auto px-6">
        <h2 className="text-4xl font-bold text-center mb-10 text-purple-800 relative">
          Featured Products
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {[1, 2, 3, 4].map((product) => (
            ...
            >
              ...
              <Link
                to={`/products/${product}`}
                className="inline-block bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-5 py-2 rounded-full transition-all duration-300 transform group-hover:scale-105"
              >
                View Details
              </Link>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {["Electronics", "Clothing", "Home", "Sports"].map(
            (category, index) => (
              ...
              >
                <span className="text-lg font-semibold text-purple-700 group-hover:text-pink-500 transition-colors duration-300">
                  {category}
                </span>
